...
const CheckIcon = () => (
    <svg viewBox="64 64 896 896" focusable="false" data-icon="check" width="12" height="12" fill="currentColor" aria-hidden="true">
...
const ErrorIcon = () => (
    <svg className="error-svg-icon" viewBox="64 64 896 896" focusable="false" data-icon="close-circle" width="1em" height="1em" fill="currentColor" aria-hidden="true">
