...
const FormItem$1 = /*#__PURE__*/React.memo(({
  ...
  const [errors, setErrors] = React.useState(getFieldError(name)?.[0]);
...
const FormItemChildComponent = /*#__PURE__*/React.memo(({
  ...
  const fieldValue = React.useMemo(() => value ?? _formFieldValue ?? initialValue, [value, _formFieldValue, initialValue]);
  React.useEffect(() => {
    if (initialValue) {
...
const Form$1 = ({
  ...
  const injectedChildren = React.useMemo(() => React.Children.map(childrenList, child => injectPropsIntoFinalLeaf(child)), [childrenList, injectPropsIntoFinalLeaf]);
...
Form$1.Item = /*#__PURE__*/React.memo(FormItem$1);
