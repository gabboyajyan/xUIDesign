...
const Button = ({
  ...
  const iconNode = innerLoading ? typeof loading === 'object' && loading.icon || jsxRuntimeExports.jsx("span", {
    className: `${prefixCls}-spinner`
  }) : icon;
  const content = jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
