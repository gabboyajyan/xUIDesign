...
const DatePicker = ({
  ...
  return jsxRuntime.jsxs("div", {
    ...
    children: [jsxRuntime.jsx("div", {
      ...
      wrapper: element => getPopupContainer ? /*#__PURE__*/reactDom.createPortal(element, getPopupContainer(targetRef.current)) : jsxRuntime.jsx(jsxRuntime.Fragment, {
        children: element
      }),
      children: jsxRuntime.jsxs("div", {
        ref: popupRef,
    ...
    children: [jsxRuntime.jsx("div", {
      ...
      children: jsxRuntime.jsx("div", {
        ...
        children: jsxRuntime.jsxs("div", {
          ...
          children: [renderCalendar(0, viewMode !== 'day'), viewMode === 'day' && renderCalendar(1, viewMode !== 'day'), jsxRuntime.jsx("div", {
            className: `${prefixCls}-arrow ${prefixClsPopupPosition}-${_placement}`
          })]
        })
      })
...
const TimePicker = ({
  ...
  return jsxRuntime.jsx("div", {
    ...
    children: jsxRuntime.jsxs("div", {
      ...
      }), clearIcon && innerValue ? jsxRuntime.jsx("span", {
        className: `${prefixCls}-clear`,
        onClick: handleClear,
        children: clearIcon
    ...
    children: [jsxRuntime.jsxs("div", {
      ...
      children: [showSearch || hasMode ? jsxRuntime.jsxs("div", {
        ...
        children: [hasMode ? jsxRuntime.jsx(jsxRuntime.Fragment, {
          ...
          }), !hasMode && !searchQuery.length ? selected === '' ? jsxRuntime.jsx("div", {
            style: {
              display: 'contents'
            },
          ...
          children: selected === '' ? jsxRuntime.jsx("div", {
            style: {
              display: 'contents'
            },
            children: placeholder
