...
import React, { useState, useEffect, useMemo, useRef, useCallback, Children, isValidElement, Fragment as Fragment$1, Suspense, useContext, createElement, createContext, useImperativeHandle, useLayoutEffect, cloneElement } from 'react';
...
const prefixClsPopupPosition = "xUi-popup-position";
...
const ButtonComponent = ({
  ...
  const iconNode = innerLoading ? typeof loading === 'object' && loading.icon || jsx("span", {
...
const DatePicker = ({
  ...
  const [currentYear, setCurrentYear] = useState(initialPickerDate ? new Date(initialPickerDate).getFullYear() : DateNow.getFullYear());
  const [currentMonth, setCurrentMonth] = useState(initialPickerDate ? new Date(initialPickerDate).getMonth() : DateNow.getMonth());
  ...
  return jsxs("div", {
    ...
    children: [jsx("div", {
      ...
      children: jsxs("button", {
        ...
        }, selectedDate?.toString()), jsxs("span", {
    ...
    }), isOpen && jsx(ConditionalWrapper, {
      condition: getPopupContainer !== undefined,
      wrapper: element => getPopupContainer ? /*#__PURE__*/createPortal(element, getPopupContainer(targetRef.current)) : jsx(Fragment, {
        children: element
      }),
      children: jsxs("div", {
        ref: popupRef,
  ...
  return jsxs("div", {
    ...
    children: [jsx("div", {
      ...
      children: jsxs("button", {
        ...
        }, `0_${selectedDates[0]?.toUTCString()}`), jsx("span", {
        ...
        }, `1_${selectedDates[1]?.toUTCString()}`), jsx("span", {
          className: `${prefixCls}-icon`,
      ...
      children: jsx("div", {
        ...
        children: jsxs("div", {
          ...
          children: [renderCalendar(0, viewMode !== 'day'), viewMode === 'day' && renderCalendar(1, viewMode !== 'day'), jsx("div", {
            className: `${prefixCls}-arrow ${prefixClsPopupPosition}-${_placement}`
          })]
        })
      })
...
function flattenChildren(children) {
  ...
  Children.forEach(children, child => {
    ...
    if (child.type === Fragment$1 || child.type === Suspense) {
      // eslint-disable-next-line @typescript-eslint/ban-ts-comment
      // @ts-expect-error
...
const FormItem = ({
  ...
  return jsxs("div", {
    ...
    children: [!props.noStyle && (label || name) && !hideLabel && jsxs("label", {
      className: `${prefixCls}-label ${prefixClsV3}-label`,
      htmlFor: name,
      ...
      if (/*#__PURE__*/isValidElement(child)) {
        ...
        return jsxs("div", {
          ...
          children: [/*#__PURE__*/createElement(FormItemChildComponent, {
            ...props,
...
const Form = ({
  ...
  return jsx(FormContext.Provider, {
    ...
    children: jsx("form", {
      ...
      children: Children.map(childrenList, injectPropsIntoFinalLeaf)
    })
  });
};
Form.Item = FormItem;
  ...
  return jsxs("div", {
    ...
    children: [addonBefore && jsx("span", {
      ...
      children: [prefix && jsx("span", {
        ...
        className: clsx([prefixCls, prefixClsV3, className])
      }), allowClear && internalValue ? jsx("span", {
        className: `${prefixCls}-clear ${prefixClsV3}-clear`,
        onClick: handleClear,
        children: jsx(ErrorIcon, {})
      }) : null, (suffix || iconRender) && jsxs("span", {
...
const Select = ({
  ...
  const ArrowContainer = useMemo(() => {
    ...
    return showSearch && isOpen ? searchIcon || jsx(SearchIcon, {}) : suffixIcon ? jsx("span", {
      style: {
        display: 'contents'
      },
      onClick: () => iconClickClear ? handleClear() : iconClick?.(),
      children: suffixIcon
    }) : showArrow && jsx(ArrowIcon, {
      isOpen: isOpen
    });
  ...
  const selectedOption = useMemo(() => {
    ...
    return jsx("div", {
      ...
      children: typeof option === 'string' ? option : option?.children || option?.label || option?.value || null
    });
  ...
  return jsxs("div", {
    ...
    children: [jsxs("div", {
      ...
      children: [showSearch || hasMode ? jsxs("div", {
        ref: tagtriggerRef,
        style: {
          ...style,
          ...(isOpen ? {
        ...
        children: [hasMode ? jsx(Fragment, {
          ...
          }), !hasMode && !searchQuery.length ? selected === '' ? jsx("div", {
            style: {
              display: 'contents'
            },
      ...
      condition: getPopupContainer !== undefined,
      wrapper: element => getPopupContainer ? /*#__PURE__*/createPortal(element, getPopupContainer(triggerNode)) : jsx(Fragment, {
        children: element
      }),
      children: !loading && open && isOpen && jsxs("div", {
        ...
        jsx(ConditionalWrapper, {
          wrapper: element => {
            return dropdownRender?.(element || jsx(Fragment, {
              children: " "
            })) || jsx(Fragment, {
              children: " "
            });
          ...
          children: jsxs("div", {
            ...
            }) : !asTag ? notFoundContent || jsx(EmptyContent, {}) : null]
          })
        })]
      })
    })]
...
const SubMenu = ({
  ...
  const handleHover = useCallback(_ => {
...
const Menu = ({
  ...
  const [openKeys, setOpenKeys] = useState(openKeysProp ?? defaultOpenKeys);
  const [selectedKeys, setSelectedKeys] = useState(selectedKeysProp ?? defaultSelectedKeys);
  ...
  const toggleOpen = useCallback((key, level) => {
      ...
      children: items ? items.map((it, index) => {
        ...
        if (it.type === 'group') {
          return jsxs("div", {
            ...
            }, `${it.key}_${index}_${it.label}_menu-item`), (it.children || []).map((c, i) => {
              return jsx(MenuItem, {
                itemKey: c.key,
                label: c.label,
                icon: c.icon,
        ...
        return it.children ? jsx(SubMenu, {
          itemKey: it.key,
          title: it.label,
          icon: it.icon,
          level: "1",
          children: it.children.map((c, idx) => {
            if (c.type === 'group') {
              return jsxs("div", {
                children: [jsx(MenuItem, {
                  ...
                  selected: selectedKeys.includes(c.key),
                  className: `${prefixCls}-item-disabled`
                }, `${c.key}_${idx}_menu-item`), (c.children || []).map((c, _i) => jsx(MenuItem, {
                  itemKey: c.key,
                  label: c.label,
                  icon: c.icon,
                  selected: selectedKeys.includes(c.key),
            ...
            return c.children ? jsx(SubMenu, {
              className: `${prefixCls}-sub-list-sub`,
              itemKey: c.key,
              title: c.label,
              icon: c.icon,
              level: "2",
              children: c.children.map((c, _idx) => jsx(MenuItem, {
                itemKey: c.key,
                label: c.label,
                icon: c.icon,
                selected: selectedKeys.includes(c.key)
              }, `${c.key}_${_idx}_${c.label}_menu-item`))
            }, `${c.key}_${c.label}_${idx}_sub_menu`) : jsx(MenuItem, {
              itemKey: c.key,
              label: c.label,
              icon: c.icon,
              selected: selectedKeys.includes(c.key)
        ...
        }, `${it.key}_${it.label}_${index}_sub_menu`) : jsx(MenuItem, {
          itemKey: it.key,
          label: it.label,
          icon: it.icon,
          selected: selectedKeys.includes(it.key)
...
const Dropdown = ({
  ...
  const popup = jsx(ConditionalWrapper, {
    condition: !!getPopupContainer,
    wrapper: element => getPopupContainer ? /*#__PURE__*/createPortal(element, getPopupContainer(targetRef.current)) : jsx(Fragment, {
      children: element
    }),
    children: jsx(Fragment, {
      children: jsxs("div", {
        ...
        children: [arrow && jsx("div", {
          className: `${prefixCls}-arrow ${prefixClsPopupPosition}-${_placement}`
        }), overlay ? typeof overlay === 'function' ? overlay() : overlay : popupRender ? popupRender(menu ? jsx(MenuInner, {
          prefixCls: prefixCls,
          items: menu.items,
          menuRef: menuRef,
...
const Popover = ({
  ...
  return jsxs(Fragment, {
    children: [_children, isOpen && jsx(ConditionalWrapper, {
      condition: !!getPopupContainer,
      wrapper: element => getPopupContainer ? /*#__PURE__*/createPortal(element, getPopupContainer(targetRef.current)) : jsx(Fragment, {
        children: element
      }),
      children: jsxs("div", {
        ...
        children: [title && jsx("div", {
          ...
          children: Children.map(_content, (child, index) => jsx("div", {
            children: child
          }, index))
        }), jsx("div", {
          className: `${prefixCls}-arrow ${prefixClsPopupPosition}-${_placement}`
...
const Result = ({
  ...
  return jsxs("div", {
    ...
    style: style,
    children: [renderIcon(), title && jsx("div", {
      className: `${prefixCls}-title`,
      children: title
    }), subTitle && jsx("div", {
...
export { ArrowIcon, ButtonComponent as Button, CalendarIcon, CheckIcon, Checkbox, ClearIcon, DateDistanceIcon, DatePicker, Dropdown, EmptyContent as Empty, ErrorIcon, Form, FormContext, FormItem, Input, LoadingIcon, Menu, MenuItem, SubMenu as MenuSubMenu, Option, Popover, Radio, RadioButton, RadioGroup, RangePicker, Result, SearchIcon, Select, Skeleton, SkeletonAvatar, SkeletonButton, SkeletonImage, SkeletonInput, SpinerIcon, StampleIcon, SuccessIcon, Switch, Tag, Textarea, TimeIcon, TimePicker, TrashIcon, Upload, clsx, createArray, flattenChildren, parseValue, useForm, useWatch };
