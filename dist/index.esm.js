...
const CheckboxClient = /*#__PURE__*/forwardRef(({
  ...
  const [internalChecked, setInternalChecked] = useState(isControlled ? checked : defaultChecked || value);
...
function CheckboxServer(props) {
  return /*#__PURE__*/React.createElement(CheckboxClient, props);
}

export { Button, CheckboxServer as Checkbox };
