    ...
    children: [jsxs("span", {
      ...
      children: fileList.map(file => jsxs("li", {
        ...
        children: [jsx("span", {
          ...
          children: listType === 'picture' && (file.originFileObj || file.url) ? jsx("img", {
            width: IMAGE_SIZE,
            height: IMAGE_SIZE,
            alt: file.name,
...
const DatePicker = ({
  ...
  return jsxs("div", {
    ...
    children: [jsx("div", {
      ...
      wrapper: element => getPopupContainer ? /*#__PURE__*/createPortal(element, getPopupContainer(popupRef.current)) : jsx(Fragment, {
        children: element
      }),
      children: jsx("div", {
        ref: popupRef,
      ...
      children: items ? items.map((it, index) => {
        ...
        if (it.type === 'group') {
          return jsxs("div", {
            ...
            }, `${it.key}_${index}_${it.label}_menu-item`), (it.children || []).map((c, i) => jsx(MenuItem, {
              itemKey: c.key,
              label: c.label,
              icon: c.icon,
